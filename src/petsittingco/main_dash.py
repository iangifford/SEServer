...
def main_dashboard():
    ...
    if current_user.is_owner:
        all_buttons += '<form action="petownerdashboard/dashboard.html" method="get" class="contact-form" data-aos="fade-up" data-aos-delay="300" role="form"> <div class="col-lg-6 mx-auto col-6"> <div class="row"> <button class="form-control" id="submit-button" >Owner Dashboard</button> </div> </div> </form>'
    # Sitter
