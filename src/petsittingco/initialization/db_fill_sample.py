...
job1 = Job(id = "1",lat=0.05, long=0.05,is_at_owner = True, canceled = False, start_datetime = "01/01/2020,15:30", end_datetime = "01/01/2020,16:30", location = "1234 Shady Lane, Baltimore, Maryland 21043", pet = pet1, sitter = acc1, owner = acc1, accepted = False, details = "Please feed twice a day with food from cabinet")
try:
    db.session.add(acc1)
