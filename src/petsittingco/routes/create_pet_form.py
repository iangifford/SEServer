...
def pet_forms():
    ...
    if form.validate_on_submit():
        ...
        pet_attr_dict = {"pet_name":form.pet_name, "pet_type":"", "other_type":"", "energetic":form.is_energetic,  "noisy":form.is_noisy, "trained":form.is_trained, "other info":form.other_info} 
        
        new_pet = Pet(id=str(uuid.uuid4()), owner_id=current_user.id, pet_name=form.pet_name, attributes=str(pet_attr_dict))
