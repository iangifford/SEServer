...
def job_forms():
    ...
    if form.validate_on_submit():
        ...
        new_job = Job(id=str(uuid.uuid4()), owner_id=current_user.id, location = form.loc, is_at_owner = form.is_at_owner, lat = 0, long = 0, start_datetime = form.start_datetime, end_datetime = form.end_datetime, details = form.details)
