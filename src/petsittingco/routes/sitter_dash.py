...
def job():
    ...
    if not job:
        ...
        job_details = '<div class="row"><p>Owner Name: ' + job.owner.first_name + '<br>Start date and time: '+job.start_datetime + '<br>End date and time: ' + job.end_datetime + '<br>Job details: ' + job.details + '</p><p style="width:50"></p><br><p>Pets: <br>' + petstring + '</p></div>'
